...
class MiniMarket(mesa.Model):
    ...
    def get_wom_records(self) -> pd.DataFrame:
        return pd.DataFrame(self.wom_records)
    ...
    def step(self) -> None:
        ...
        for storyteller in storytellers:
            ...
            for listener in listeners:
                risk_before = listener.perceived_risk_a
                ...
                wom_record = {
                    ...
                    "storyteller_id": storyteller.customer_id,
                    "listener_id": listener.customer_id,
                    "storyteller_x": storyteller.x,
                    "storyteller_y": storyteller.y,
                    "listener_x": listener.x,
                    "listener_y": listener.y,
                    "risk_before": risk_before,
                    "risk_after": listener.perceived_risk_a,
                    "wom_strength": self.wom_strength,
                }
                self.daily_wom_records.append(wom_record)
                self.wom_records.append(wom_record)
